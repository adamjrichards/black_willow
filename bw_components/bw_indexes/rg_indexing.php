...
function build_a_filename_index_widget( $this_index, $how_many_to_show_at_a_time ) {
	...
	for( $i = 0; $i < $the_file_count; $i++ ) {
		...
		$the_file_path = "rg_rg_assets/rg_rg_posts/" . $this_index[ $i ];
...
function build_an_index_widget( $this_index, $the_filename_index, $how_many_to_show_at_a_time ) {
	...
	for( $i = 0; $i < $the_file_count; $i++ ) {
		...
		$the_file_path = "rg_rg_assets/rg_rg_posts/" . $the_filename_index[ $i ];
		$the_tag = "<li><a href='rg_assets/rg_posts/" . $the_filename_index[ $i ] . " '>" . $this_index[ $i ] . "</a></li>";
		$the_html .= $the_tag;
