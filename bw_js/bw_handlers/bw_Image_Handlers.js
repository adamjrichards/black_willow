...
class bw_Image_Handlers {

	static get_the_images_dimensions( the_filename ) {
	...
	static get_the_images_width( the_filename ) {
		return get_the_images_dimensions( the_filename )[0];
	}

	static get_the_images_height( the_filename ) {
