...
class bw_String_Handlers {

	title_case( the_phrase ) {
	...
	truncate_the_phrase_to_this_many_words( the_phrase, how_many_words = 2 ) {
	...
	change_the_phrase_to_title_case( the_phrase ) {
		var the_words = the_phrase.split( " " );
		var the_new_phrase = "";
		for ( this_word of the_words ) {
