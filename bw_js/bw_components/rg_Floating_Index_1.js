function Floating_Index( me ) {
	
	if( me.id == "" ){
		me.id = "floating_index_" + get_me_a_random_int( 1000, 10000 );
	} 
	...
	var add_my_listeners = function(){
		...
		me.change_my_className( " pinned ", " floating " );
	...
	var remove_my_listeners = function(){
		...
		me.change_my_className( " floating ", " pinned " );
