...
matrixObject.prototype.draw = function( caption, name, type, clearTables ) {
	...
	var cellCode = "#td class='result_table_cell " + name + "_cell'>#input type='text' class='result_form_input' id='result_form_input_" + name + "_" + this.rows + "_" + this.columns + "' " + readOnly + "' size='8' value='";
	var cellCloser = "'>#/input>#/td>";
	var rowCloser = "#/tr>";
