...
function buildMatrixEntryTableA( origin, displayResult ) {
	...
	for ( i = 0; i < rows_A; i++ ) {
		...
		for ( j = 0; j < columns_A; j++ ) {
			cellCode = "#td class='matrix_table_cell matrix_table_a_cell'>#input type='text' class='matrix_form_input matrix_form_input_a' id='matrix_form_input_a_" + i + "_" + j + "' readonly size='2' value='0' onmousedown='goToStepTwo()' onmouseup='this.value=\"\"'>#/td>";
...
function buildMatrixEntryTableB( origin, displayResult ) {
	...
	for ( i = 0; i < rows_B; i++ ) {
		...
		for ( j = 0; j < columns_B; j++ ) {
			cellCode = "#td class='matrix_table_cell matrix_table_b_cell'>#input type='text' class='matrix_form_input matrix_form_input_b' id='matrix_form_input_b_" + i + "_" + j + "' readonly size='2' value='0' onmousedown='goToStepTwo()' onmouseup='this.value=\"\"'>#/td>";
			tableString += cellCode;
		} // for
		tableString += rowCloser;
	} // for
