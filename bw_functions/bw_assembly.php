...
function retrieve_the_content_from_the_source_page( $in_this_file, $of_this_type, $with_this_path ) {
	switch ( $of_this_type ) {
		...
		case "post"	:	$the_path = "rg_rg_assets/rg_rg_posts/$of_this_type"; break;
		case "poem"	:	$the_path = "rg_rg_assets/rg_rg_poems/$of_this_type"; break;
		default		:	$the_path = "rg_rg_assets/rg_rg_$with_this_path/$in_this_file.php";
	}
